  ...
  const clueCards = [
    {
      ...
      title: "Attempt 1",
      clue: "Nationality or Club",
      description: "The player's country or club are revealed.",
    },
    {
  ...
  return (
    <Dialog open={isAboutOpen} onOpenChange={setIsAboutOpen}>
      <DialogContent className="sm:max-w-3xl w-[95vw] max-h-[90vh] overflow-y-auto p-0 bg-[#1a1a1a] text-white border-2 sm:border-3 border-zinc-700 rounded-lg">
        <main className="w-full bg-[#1a1a1a] text-white text-sm">
          {/* Hero */}
          <section className="border-b border-zinc-800 px-4 sm:px-8 md:px-10 py-6">
            <div className="max-w-6xl mx-auto">
              ...
              <p className="mt-3 sm:mt-4 text-sm text-zinc-400 max-w-3xl leading-relaxed">
                Every day you'll be challenged with a famous football match.
                Some players have been hidden from the starting XI. Your
                objective is to identify every hidden player using the fewest
                clues possible.
              </p>
            </div>
          </section>
          ...
          <section className="max-w-6xl mx-auto px-4 sm:px-8 md:px-10 py-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-4 sm:p-5">
                ...
                <p className="text-sm text-zinc-400 leading-relaxed">
                  Identify every hidden player before revealing all of the
                  clues. Every incorrect guess or clue reduces your final score.
                </p>
              </div>
            </div>
          </section>
